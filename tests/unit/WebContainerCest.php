...
//    }
    ...
    public function checkCronServiceIsRunning(UnitTester $I){
        ...
        $I->runShellCommand("docker exec uat_web_ubuntu service crond status");
        $I->seeInShellOutput('active (running)');
    }
    ...
    public function checkSSHInstallation(UnitTester $I){
            ...
            $I->runShellCommand("docker exec uat_web_ubuntu rpm -qa | grep openssh-server");
    ...
    public function checkSSHServiceRunning(UnitTester $I){
            ...
            $I->runShellCommand("docker exec uat_web_ubuntu service sshd status");
            $I->seeInShellOutput('active (running)');
    }
    ...
    public function checkOpenldapInstallation(UnitTester $I){
            ...
            $I->runShellCommand("docker exec uat_web_ubuntu rpm -qa | grep openldap");
    ...
    public function checkNSCDInstallation(UnitTester $I){
            ...
            $I->runShellCommand("docker exec uat_web_ubuntu rpm -qa | grep nscd");
            $I->seeInShellOutput("nscd-2");
    }

    public function checkJavaVersion(UnitTester $I){
            $I->wantTo("verify java is installed in the container");
            $I->runShellCommand("docker exec uat_web_ubuntu rpm -qa | grep java-1.8.0-openjdk");
    ...
    public function checkWgetVersion(UnitTester $I){
            ...
            $I->runShellCommand("docker exec uat_web_ubuntu rpm -qa | grep wget");
...
//    }
    ...
    public function checkSendMailNoArch(UnitTester $I){
        ...
        $I->runShellCommand("docker exec uat_web_ubuntu yum list installed | grep sendmail");
